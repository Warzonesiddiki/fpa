...
- [ ] **M2-3** Validation + preview + HARD/WARNING engine (S-031) — registered core exists; S-031 visibly gates its first-50-row/remediation UI rather than fabricating raw-row preview data.
