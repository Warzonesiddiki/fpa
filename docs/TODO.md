...
- [ ] **M2-1** Import hub + parser (calamine: xlsx/xls/csv/tsv/zip, encodings, locale numbers) (S-030) — bounded UI/IPC path built: S-030 real-IPC parse entry, Company-scoped store, native picker/drop, exact parser states/errors, XLSX/XLS/ODS/CSV/TSV/TXT, and S-031 hand-off. ZIP, progress/cancel/streaming, `import.history`, 500k benchmark, and native cargo gates remain.
