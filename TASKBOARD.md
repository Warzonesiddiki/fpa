...
| platform                           | —                                                                            | backup._, settings._, update.check, app.diagnostics.export, reconcile._, connector._, driver._ (TS contract + mock built, M3-3 🚧), assumption._, cycle._, collection._ |
